...
def get_db_connection():
    # connect_timeout prevents infinite hanging
...
def handle_login():
    ...
    try:
        ...
        if result and result[0] != user_ip:
            return "Key locked to another device."
        elif not result:
        ...
        pass # Allow login if DB is temporarily shaky
...
def ask_ai():
    ...
    system_msg = {"role": "system", "content": "You are Opti AI. End tips with [EFF: X] [RSK: Y]."}
...
if __name__ == "__main__":
    # THIS LINE FIXES THE "NO OPEN HTTP PORTS" ERROR
